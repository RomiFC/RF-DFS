  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \matrix[wire board, wiresright] (converter) {
        ...
        \draw(lps-6-4) -- (lps-6-4 -| m) coordinate(gndm);
        \draw(gndm) |- (db9-5-2);
        \draw(gndm) |- (db9-7-2);
        \draw(gndm) |- (db9-9-2);
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \matrix[wire board, wiresright] (plc) {
        asdf   &  V1  &   \scriptsize D-001   \\
        asdf   &  1   &   \scriptsize D-001   \\
        asdf   &  2   &   \scriptsize D-002   \\
        asdf   &  3   &   \scriptsize D-003   \\
        asdf   &  4   &   \scriptsize D-004   \\
        asdf   &  5   &   \scriptsize Black   \\
        asdf   &  6   &   \scriptsize Black   \\
        asdf   &  7   &   \scriptsize Black   \\
        asdf   &  8   &   \scriptsize Black   \\
        asdf   &  V2  &   \scriptsize D-001   \\
        asdf   &  9   &   \scriptsize D-001   \\
        asdf   &  10  &   \scriptsize D-002   \\
        asdf   &  11  &   \scriptsize D-003   \\
        asdf   &  12  &   \scriptsize D-004   \\
        asdf   &  13  &   \scriptsize Black   \\
        asdf   &  14  &   \scriptsize Black   \\
        asdf   &  15  &   \scriptsize Black   \\
        asdf   &  0V  &   \scriptsize Black   \\
        };
        ...
        \draw (p3) node[anchor=south east, align=right]{\textbf{Switches S2 and S3}};
        ...
        \draw (p3) node[anchor=south east, align=right]{\textbf{Switch 1}};

        % WIRING 
        % NOTE: WIRE FROM THE SMALL TEXT CORNER ANCHOR, NOT THE NUMBERED ANCHORS
        \draw(plc-1-2) -- (lps-1-2);
        \draw(plc-2-2) -- (lps-2-2);
        \draw(plc-3-2) -- (lps-3-2);
        \draw(plc-4-2) -- (lps-4-2);
        \path(plc-5-2) -- coordinate[midway](m) (lps-5-2);
        \draw(plc-5-2) -- (m) |- (lps-6-2);

        \path(lps-1-4) -- coordinate[midway](m) (emsswitches-1-2);
        \path(lps-1-4) -- coordinate[midway](1quarter) (m);
        \path(m) -- coordinate[midway](3quarter) (emsswitches-1-2);
        \path(1quarter) -- coordinate[midway](3eighth) (m);
        \path(m) -- coordinate[midway](5eighth) (3quarter);

        \draw(lps-1-4) -- (3eighth) -- (emsswitches-3-2 -| 5eighth) -- (emsswitches-3-2);
        \draw(lps-2-4) -- (lps-2-4 -| 3eighth) -- (emsswitches-4-2 -| 5eighth) -- (emsswitches-4-2);
        \draw(lps-3-4) -- (lps-3-4 -| 3eighth) -- (5eighth) -- (emsswitches-1-2);
        \draw(lps-4-4) -- (lps-4-4 -| 3eighth) -- (emsswitches-2-2 -| 5eighth) -- (emsswitches-2-2);
        \draw(lps-6-4) -- (lps-6-4 -| m) coordinate(gndm);
        \draw(gndm) |- (emsswitches-5-2);
\end{tikzpicture}
\end{center}
