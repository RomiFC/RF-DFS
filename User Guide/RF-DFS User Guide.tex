...
\end{tikzpicture}
\end{center}
\caption{RS-485 serial wiring diagram for connecting the PC to the ACR9000 motor controller.}\label{fig:serialwiring}
\end{figure}
...
The major components located in the RF-EMS tower are as follows:
\begin{enumerate}
...
\begin{figure}
  \begin{center}
    \begin{circuitikz}
      ...
      \draw(dc1.south |- termblocknw) node[anchor=south west, color=brown]{\footnotesize Br};
      \draw(dc2.south |- termblocknw) node[anchor=south west, color=orange]{\footnotesize Or};
      \draw(dc3.south |- termblocknw) node[anchor=south west, color=yellow!60!orange!100]{\footnotesize Yw};
