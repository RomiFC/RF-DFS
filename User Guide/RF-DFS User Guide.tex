  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \matrix[wire board,converter] (converter) {
        ...
        \matrix[wire board, lps, matrix anchor=north, right=5cm of converter.north] (lps) {
          \scriptsize D-006 &   A   &  -----  &  M  & \scriptsize Green\\
          \scriptsize D-004 &   B   &  -----  &  L  & \scriptsize Black\\
          \scriptsize D-005 &   C   &  -----  &  K  & \scriptsize Black\\
          \scriptsize D-007 &   D   &  -----  &  J  & \scriptsize Black\\
          \scriptsize D-001 &   F   &  -----  &  G  & \scriptsize \\
          \scriptsize D-008 &   E   &  GND    &  H  & \scriptsize Black\\
        };
        % Boxing the contents
        ...
        \draw (p1) (current subpath start -| lps-1-3) node[anchor=south, font=\bfseries]{LPS};

        % DB9 CONNECTOR
        \matrix[wire board, db9, matrix anchor=north, right=5cm of lps.north] (db9) {
...
\end{tikzpicture}
\end{center}
\caption{Serial wiring diagram.}\label{fig:serialwiring}
\end{figure}
