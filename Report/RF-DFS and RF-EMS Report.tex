...
\begin{figure}[!ht]
    \begin{center}
        \begin{circuitikz}
            ...
            \draw(sw1lab.north) [dashed, <-] -- ++ (0, 2) node[anchor=south]{PLC};
            \draw(sw2lab.north) [dashed, <-] -- ++ (0, 0.8) node[anchor=south]{PLC};
            \draw(sw3lab.north) [dashed, <-] -- ++ (0, 0.8) node[anchor=south]{PLC};
        \end{circuitikz}
